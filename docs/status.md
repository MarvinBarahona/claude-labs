...
| Structured Output Console | Feature | `structured-output-console` | 🔵 In progress | [`feature-structured-output-console.md`](planning/feature-structured-output-console.md) |
