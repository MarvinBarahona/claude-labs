...
- [ ] Confirm both `messages-console` (already `Done`, see `messages-console.md`) and `structured-output-console` (already `Done`, see `structured-output-console.md`) are `Done` before starting.
